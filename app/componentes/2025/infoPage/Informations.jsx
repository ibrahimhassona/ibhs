...
const Informations = ({ data }) => {
  ...
  return (
    ...
    >
      <div className="mb-6">
        <h1 className="text-3xl max-md:text-xl font-bold mb-2 ">{data.name}</h1>
      ...
      >
        {
          <motion.a
            ...
            whileHover="hover"
            className="max-sm:flex items-center gap-1 m-auto hover:text-primary cust-trans hidden"
          >
        ...
        {contactItems.map((item, index) => (
          <motion.a
            ...
            variants={itemVariants}
            whileHover="hover"
            className="flex items-center gap-1 m-auto hover:text-primary cust-trans"
          >
